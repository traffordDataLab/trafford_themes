...
df  <- read_csv(paste0("https://www.nomisweb.co.uk/api/v01/dataset/NM_17_5.data.csv?geography=",paste(c("E92000001",bm$area_code, "E08000009"), collapse = ','),"&date=latest-latestMINUS13&variable=111&measures=20599,21001,21002,21003")) %>%
...
write_csv(df, "../economic_inactivity.csv")

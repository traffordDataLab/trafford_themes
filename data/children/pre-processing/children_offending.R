...
# URL: https://www.gov.uk/government/statistics/youth-justice-statistics-2022-to-2023
# Licence: Open Government Licence v3.0

library(tidyverse) ; library(readODS)

url <- "https://assets.publishing.service.gov.uk/media/65b0ea841702b1000dcb116d/Local_level_open_data_tables.zip"
